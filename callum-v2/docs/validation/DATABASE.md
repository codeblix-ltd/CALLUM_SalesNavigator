...
| `V2_TEST_DB=1 node --env-file=<local server env> --test tests/db.integration.test.mjs` | Pass after fixing run-ID bug | Actual DB command lease, reconciliation and unique pay line | Live LinkedIn click or full concurrent load |
