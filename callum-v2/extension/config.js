globalThis.CallumConfig = Object.freeze({
  validate(x) {
    ...
    const optional = ['postScope','postLink','commentButton','contactLink','contactDialog','contactEmail','invitationPage','invitationCard','invitationProfile','invitationAge','invitationWithdraw'];
